...
//SQL QUERY `SELECT * FROM role` USED FOR ADD/UPDATE FUNCTIONS
...
//PROMPT "View All Roles" | VIEW ROLES WITH AN ADDTIONAL COLUMN "department" FROM EXTENDED TABLE (JOIN)
const viewRoles = () => {
    return new Promise((resolve, reject) => {
        const db = require("../db/connections");
...
//PROMPT "Add Role" | ADD NAME OF ROLE(input), SALARY(input), AND DEPARTMENT(list - from "viewDepartments")
